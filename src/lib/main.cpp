...
std::cout<<"pick_point_inside_mirror_region:"<< std::endl;
  ...
  std::
   ...
   vetor_3d result2 (0, 0, 0);
    ...
    vetor_3d vetor_origem_da_reta (0, 0, 0);
    vetor_3d sun_direction(0, 0, 0); 
    vetor_3d normal_do_espelho_cortado_pela_reta(0, 0, 0); 
    float d = 0;
    
 result2 = h2.intersec_plano_reta(vetor_origem_da_reta,sun_direction,normal_do_espelho_cortado_pela_reta,d);
 
 std::cout << "Coordenada x: " << result2.P[0]<< std::endl;
 std::cout << "Coordenada y: " << result2.P[1] << std::endl;
 std::cout << "Coordenada z: " << result2.P[2] << std::endl;
  return 0;
}
