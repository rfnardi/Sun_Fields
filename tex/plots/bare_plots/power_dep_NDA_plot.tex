...
\begin{figure}[!htb]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[mark size=0.5pt, color=blue] table[x=NDA, y=POWER, col sep=semicolon] {../../../data/bare_data/pot_dep_NDA.dat};
		\end{axis}
	\end{tikzpicture}
...
\begin{figure}[!htb]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[mark size=0.5pt, color=blue] table[x=NDA, y=ZEN, col sep=semicolon] {../../../data/bare_data/pot_dep_NDA.dat};
		\end{axis}
	\end{tikzpicture}
...
\begin{figure}[!htb]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[mark size=0.5pt, color=red] table[x=NDA, y=S_z, col sep=semicolon] {../../../data/bare_data/pot_dep_NDA.dat};
		\end{axis}
	\end{tikzpicture}
