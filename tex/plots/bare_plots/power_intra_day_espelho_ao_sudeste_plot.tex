...
\begin{center} { \large Estudo da potência refletida intraday: { \bf espelho ao sudeste do ponto focal}} \end{center}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[mark size=0.5pt, color=red] table[x=HORA_LOCAL, y=POWER, col sep=semicolon] 
				{../../../data/bare_data/pow_one_mirror_intra_day_espelho_ao_sudeste.dat};
		\end{axis}
	\end{tikzpicture}
