...
\begin{figure}[!htb]
	...
	\begin{tikzpicture}
		\begin{axis}[height=16cm, width=16cm, grid=major, xlabel={NDA},ylabel={Power ($W$)},title={Potência ao longo do ano}]
			
			\addplot[mark size=0.5pt, color=blue] table[x=NDA, y=POWER, col sep=semicolon] {pot_dep_NDA.dat};
